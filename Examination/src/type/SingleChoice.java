 ...
 * @author 11219
 */
public class SingleChoice extends JFrame{
    private int preId;
    ...
    public SingleChoice(String subject, String type, int preId) {
    ...
    private void insertQuestion(Connection connection, String content, String difficulty, String topic, int score, String type, String imagePath, String audioPath) throws SQLException {
        ...
        QuestionUploader.uploadOptions(connection, questionId, textField3.getText(), textField4.getText(), textField5.getText(), textField6.getText(),
                isCorrectOption(comboBox1.getSelectedItem().toString().equals("A")),
                isCorrectOption(comboBox1.getSelectedItem().toString().equals("B")),
                isCorrectOption(comboBox1.getSelectedItem().toString().equals("C")),
                isCorrectOption(comboBox1.getSelectedItem().toString().equals("D")));
    }
        ...
        try (PreparedStatement updateQuestionStatement = connection.prepareStatement(updateQuestionQuery)) {
            ...
            if (rowsAffected > 0) {
                ...
                QuestionUploader.updateOptions(connection, questionId, textField3.getText(), textField4.getText(), textField5.getText(), textField6.getText(),
                        isCorrectOption(comboBox1.getSelectedItem().toString().equals("A")), isCorrectOption(comboBox1.getSelectedItem().toString().equals("B")),
                        isCorrectOption(comboBox1.getSelectedItem().toString().equals("C")), isCorrectOption(comboBox1.getSelectedItem().toString().equals("D")));
    ...
    private void uploadQuestionAndOptions(ActionEvent e) {
        ...
        imagePath = ImageUploader.uploadImage(this);
    ...
    private void initComponents() {
        ...
        //---- button2 ----
        JButton button2 = new JButton("画图");
